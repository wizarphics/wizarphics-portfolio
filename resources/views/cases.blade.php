        ...
        <div class="container my-5">
            <div class="row justify-content-center text-center">
                <div class="col-10 col-md-8 col-lg-6">
                    ...
                    <p class="px-4 lead">A small selection of projects I've worked on - including those completed by
                        myself and as a team..</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row row-cols-lg-3 justify-content-center gap-4 g-5">
                @foreach ($cases as $case)
                    <x-col-card title="{{ $case->title }}" subtext="{{ $case->short_desc }}" :image="$case->image"
                        link="{{ $case->link }}" cta="View" />
