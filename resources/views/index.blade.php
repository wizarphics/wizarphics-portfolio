<x-app-layout hasLatestPosts="true">
    ...
    <section class="px-4 z-n1 py-5 m-2 m-md-4 rounded-5 overflow-x-hidden d-flex position-relative align-items-center
    bg-black"
             style="height:650px;">
        ...
        <div class="area h-100 w-100 position-absolute z-0">
            <ul class="circles">
                ...
                <li><img
                        src="https://discover.strongdm.com/hs-fs/hubfs/google-cloud-logo.png?width=300&height=300&name=google-cloud-logo.png"
                        style=""
                        alt="Google Cloud Logo" class="w-100 h-100"></li>
                <li><img src="https://codeigniter.com/assets/icons/44521256.png"
                         alt="Codeigniter Logo" class="w-100 h-100"></li>
                <li><img src="https://upload.wikimedia.org/wikipedia/commons/3/3d/LaravelLogo.png"
                         alt="Laravel Logo" class="w-100 h-100"></li>
                <li><img src="https://cdn.worldvectorlogo.com/logos/react-2.svg"
                         alt="React Logo" class="w-100 h-100"></li>
                <li><img src="https://cdn.worldvectorlogo.com/logos/nodejs-1.svg"
                         alt="NodeJs Logo" class="w-100 h-100"></li>
                <li><img src="https://cdn.worldvectorlogo.com/logos/php-1.svg"
                         alt="PHP Logo" class="w-100 h-100"></li>
            </ul>
        </div>
                ...
                <div class="col-md-8 text-center mx-auto">
                    <h1 class="mb-2 text-light display-5 fw-bold">I am
                        <span class="dynamic-type text-primary"
                              data-variants="a Web Developer, a Problem Solver, a Graphics Designer, an Experience Shaper, an Innovator"></span>.
                    </h1>
        ...
        <div class="container my-5 pt-5">
            <div class="row justify-content-between flex-column flex-md-row">
                <div class="col-md-6 col-lg-6 col-xl-6 p-4">
                    ...
                    <p>Experience the power of your brand/business unleashed. Discover my comprehensive range of services and unlock new possibilities. View my offers and let's embark on a transformative journey together. <span role="button" class="d-none d-md-inline">👉</span>
                        <span role="button" class="d-inline d-md-none">👇</span></p>
                    <div class="row mt-5">
                        <div class="col-6">
                    ...
                    <div class="vstack d-none d-md-flex">
                        <div href="#" class="d-flex gap-4 align-items-center">
                            ...
                            <div class="vstack justify-content-center">
                                <h3 class="mb-1 fs-5">Website Development</h3>
            ...
            <div class="row justify-content-between gap-4 gy-5 gx-4">
                <div class="col-md card border-light-subtle shadow rounded-4">
                    <div class="card-img-top mt-n4 bg-black rounded-4 overflow-hidden" style="height: 300px;">
                        <img src="/outsyd.png" data-hover-src="/outsyd-alt.png"
                             class="object-fit-contain mt-5 h-100 w-100" alt="...">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Outsyd Website</h5>
                        ...
                        <div class="row justify-content-between p-3 pb-0">
                            <div class="col-7 d-flex align-items-center gap-1">
                                <div style="height: 24px; width: 24px;" class="rounded-circle avatar overflow-hidden">
                                    <img src="/bitmoji.jpg" alt="User Image" class="object-fit-contain h-100 w-100"/>
                                </div>
                                <span class="fw-medium small text-white-50" style="font-size: 12px;">@wizarphics</span>
                            </div>
                            <div class="col-2">
                                <a href="https://github.com/wizarphics" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#378fe9"
                    ...
                    <div class="slide card border-0 rounded-4">
                        <div class="row justify-content-between p-3 pb-0">
                            <div class="col-7 d-flex align-items-center gap-1">
                                <div style="height: 24px; width: 24px;" class="rounded-circle avatar overflow-hidden">
                                    <img
                                        src="https://pbs.twimg.com/profile_images/1484692654155776001/mrnBx-My_400x400.jpg"
                                        alt="User Image" class="object-fit-contain h-100 w-100"/>
                                </div>
                                <span class="fw-medium small text-white-50" style="font-size: 12px;">@just_2_wise</span>
                            </div>
                            <div class="col-2">
                                <a href="https://github.com/wizarphics" target="_blank">
